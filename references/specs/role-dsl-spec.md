...
Подробные таблицы прав для каждого типа объекта — в `../../skills/role-compile/dsl-reference.md`.
...
DSL принимает русские имена типов и прав, транслируя их в английские. Полные таблицы соответствий — в `../../skills/role-compile/dsl-reference.md`.
...
- [Гайд по ролям](../use-cases/rights-access.md) — сценарии использования, рабочий цикл
